...
from classifier.cnn import Kim_CNN2
from classifier.cnn import ConjWeight_CNN2
from classifier.cnn import ConjWeightAllVec_CNN2
...
if __name__ == "__main__":
    ...
    if m==2:
        ...
        cnn_extractor = ConjWeightAllVecCNNExtractor2()
    ...
    if m==1:
        ...
        clf = ConjWeight_CNN2(**common_args)
    elif m==8:
        clf = ConjWeightAllVec_CNN2(weight_range=(cnn_extractor.min_weight, cnn_extractor.max_weight), **common_args)
